 ...
 */
                ...
                lastIntent.setClass(Activity_dynamic.this, GestureLock.class);
                lastIntent.putExtra("password",password);
                lastIntent.putExtra("jsonstring",json_upload);
                final AlertDialog.Builder normalDialog =
                        new AlertDialog.Builder(Activity_dynamic.this);
                normalDialog.setIcon(android.R.drawable.ic_menu_upload);
                normalDialog.setTitle("Upload answers");
                normalDialog.setMessage("Would you like to upload answers now?");
